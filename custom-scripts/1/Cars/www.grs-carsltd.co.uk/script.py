...
data = {"356": "//div[contains(@class, '')]//div[contains(@class, 'one')]//li[3]/text()", "384": "//div[@id='results-filters']//li[1]/a[contains(@class, 'next')]", "385": "//div//div[contains(@class, 'two')]//li[4]/text()", "361": "//div[contains(@class, 'veh')]//a//@src"}

data_sq = ["385", "356", "361", "355", "362", "383", "420 - 0", "384"]

data_urls = {"356": "http://www.grs-carsltd.co.uk/used-cars-melksham-wiltshire", "384": "http://www.grs-carsltd.co.uk/search_page.php?sort=h&p=3", "385": "http://www.grs-carsltd.co.uk/used-cars-melksham-wiltshire", "361": "http://www.grs-carsltd.co.uk/used-cars-melksham-wiltshire"}

target_dir = '/home/ubunto/Documents/Work/robert/Xweb/custom-scripts/1/Cars/www.grs-carsltd.co.uk'
